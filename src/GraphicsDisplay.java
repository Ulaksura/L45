...
public class GraphicsDisplay extends JPanel {
    ...
    private ArrayList<double[][]> undoHistory = (ArrayList)new ArrayList<double[]>(5);
    ...
    private void paintGraphics(Graphics2D canvas) {
        ...
        for (Double[] point : this.graphicsData) {
            ...
            if (currentX != null && currentY != null) {
                ...
                if (isGrowing(currentY.intValue()) == true) {
                    canvas.setColor(Color.green);
                    Ellipse2D.Double ellipse2D = new Ellipse2D.Double();
                    Point2D.Double center = translateXYtoPoint(point[0].doubleValue(), point[1].doubleValue());
                    ellipse2D.setFrameFromDiagonal(shiftPoint(center, -10, -10), shiftPoint(center, 10, 10));
    ...
    private void paintMarkers(Graphics2D canvas) {
        ...
        GeneralPath.Double lastMarker = null;
        int i = -1;
        int radius=1;
        for (Double[] point : this.graphicsData) {
            i++;
            GeneralPath.Double marker = new GeneralPath.Double();
           Point2D.Double center = translateXYtoPoint(point[0].doubleValue(), point[1].doubleValue());

            marker.moveTo(center.getX(), center.getY());
            marker.lineTo(center.getX(),center.getY()+11);
            marker.moveTo(center.getX(), center.getY());
            marker.lineTo(center.getX(),center.getY()-11);
            marker.moveTo(center.getX(), center.getY());
            marker.lineTo(center.getX()-11,center.getY());
            marker.moveTo(center.getX(), center.getY());
            marker.lineTo(center.getX()+11,center.getY());
            marker.moveTo(center.getX(), center.getY());
            marker.lineTo(center.getX()-11,center.getY()-11);
            marker.moveTo(center.getX(), center.getY());
            marker.lineTo(center.getX()+11,center.getY()+11);
            marker.moveTo(center.getX(), center.getY());
            marker.lineTo(center.getX()-11,center.getY()+11);
